...
import InfluencerChangePassword from "./screens/Influencer/Settings/InfluencerChangePassword";
...
import BrandChangePassword from "./screens/Brand/Settings/BrandChangePassword";
...
const App = () => {
  ...
  const [fontsLoaded, error] = useFonts({
    ...
    // Load the Ionicons glyph font under its family name ("Ionicons"), but from
    // a PROJECT-LOCAL copy — not `...Ionicons.font`, whose asset URL contains
          ...
          <SocketContextProvider>
            <NavigationContainer>
              ...
              >
                ...
                />
                <Stack.Screen
                  name="InfluencerChangePasswordPage"
                  component={InfluencerChangePassword}
                  options={{ headerShown: false }}
                />
                <Stack.Screen
                ...
                />
                <Stack.Screen
                  name="BrandChangePasswordPage"
                  component={BrandChangePassword}
                  options={{ headerShown: false }}
                />
