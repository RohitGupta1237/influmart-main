...
const configs = {
  ...
  // forbidden (403), the next is tried automatically. Falls back to the jdbc
  ...
  INSTAGRAM_APP_ID: process.env.INSTAGRAM_APP_ID || process.env.INSTAGRAM_CLIENT_ID,
  INSTAGRAM_APP_SECRET: process.env.INSTAGRAM_APP_SECRET || process.env.INSTAGRAM_CLIENT_SECRET,
